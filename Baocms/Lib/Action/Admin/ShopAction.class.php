...
class ShopAction extends CommonAction
{
    ...
    private $edit_fields = array('user_id', 'cate_id', 'city_id', 'area_id', 'business_id', 'shop_name', 'mobile', 'logo', 'photo', 'addr', 'tel', 'extension', 'contact', 'tags', 'near', 'business_time', 'delivery_time', 'is_pei', 'orderby', 'lng', 'lat', 'price', 'is_ding', 'recognition', 'apiKey', 'mKey', 'partner', 'machine_code','service','service_audit');
