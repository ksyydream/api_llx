...
.coupon-list2 { margin-top: 5px;}
</style>

	
	<header class="top-fixed bg-yellow bg-inverse">
		<div class="top-back">
			<a class="top-addr" href="<?php echo U('mall/detail',array('goods_id'=>$detail['goods_id']));?>"><i class="icon-angle-left"></i></a>
		</div>
		<div class="top-title">
			商品点评
		</div>
 ...
 <div id="coupon-list" class="coupon-list2"></div>
    <script>
        $(document).ready(function () {
            loaddata('<?php echo U("mall/dianpingloading",array("goods_id"=>$detail["goods_id"],"p"=>"0000"));?>', $("#coupon-list"), true);
        });
    </script>
