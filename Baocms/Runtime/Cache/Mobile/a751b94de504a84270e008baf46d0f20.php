...
<link href="/static/default/wap/css/dianping.css" rel="stylesheet">
	...
	<header class="top-fixed bg-yellow bg-inverse">
        ...
        <div class="top-ping">
        <a href="<?php echo U('mcenter/dianping/index',array('shop_id'=>$detail['shop_id']));?>" class="top-addr icon-pencil-square-o"> 点评</a>
		</div>
	</header>
...
<ul id="shangjia_tab">
        <li style="width:16.66666667%;"><a href="<?php echo U('shop/detail',array('shop_id'=>$detail['shop_id']));?>">首页</a></li>
        <li style="width:16.66666667%;"><a href="<?php echo U('shop/tuan',array('shop_id'=>$detail['shop_id']));?>">团购</a></li>
        <li style="width:16.66666667%;"><a href="<?php echo U('shop/life',array('shop_id'=>$detail['shop_id']));?>">信息</a></li>
        ...
        <li style="width:16.66666667%;"><a href="<?php echo U('shop/dianping',array('shop_id'=>$detail['shop_id']));?>"   class="on">评价</a></li>
</ul>
 ...
 <div id="coupon-list" class="coupon-list2"></div>
    <script>
        $(document).ready(function () {
            loaddata('<?php echo U("shop/dianpingloading",array("shop_id"=>$detail["shop_id"],"p"=>"0000"));?>', $("#coupon-list"), true);
        });
    </script>
