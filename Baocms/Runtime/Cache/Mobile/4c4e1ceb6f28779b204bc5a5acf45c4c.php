...
<?php if(is_array($list)): foreach($list as $key=>$var): ?><div class="item">	
	<div class="line">
		...
		<div class="x10">
			...
			<p class="info7 x12" >
				<?php if(is_array($pics)): $index = 0; $__LIST__ = $pics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pic): $mod = ($index % 2 );++$index; if(($pic["order_id"]) == $var['order_id']): ?><div class="pics" class="ac" onclick="liclick(this);" href="javascript:;">
