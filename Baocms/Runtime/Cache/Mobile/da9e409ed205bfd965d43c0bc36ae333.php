...
<style>
.more-service .more-list a .icon{display: block;
    margin: auto;
...
<div class="more-service">
    	...
    	<div class="more-list">
 		<?php if(is_array($nav)): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><a href="/mobile/<?php echo ($item["url"]); ?>">
                <div class="icon <?php echo ($item["ioc"]); ?> <?php echo ($item["colour"]); ?>"></div>
    			<p><?php echo ($item["nav_name"]); ?></p>
