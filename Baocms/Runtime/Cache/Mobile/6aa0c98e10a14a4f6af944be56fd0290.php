                ...
                <div class="flexslider_cate"> 
                    <ul class="slides">
                        ...
                        <?php if(is_array($nav)): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i; if($i%8 == 1): ?><li class="list">
                                    <ul class="cate">
                                       <li><a href="/mobile/<?php echo ($item["url"]); ?>"><div class="icon <?php echo ($item["ioc"]); ?> <?php echo ($item["colour"]); ?>"></div><p><?php echo ($item["nav_name"]); ?></p></a></li>
                                        <?php elseif($i%8 == 0): ?>        
                                ...
                                <?php else: ?>
                               <li><a href="/mobile/<?php echo ($item["url"]); ?>"><div class="icon <?php echo ($item["ioc"]); ?> <?php echo ($item["colour"]); ?>"></div><p><?php echo ($item["nav_name"]); ?></p></a></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
