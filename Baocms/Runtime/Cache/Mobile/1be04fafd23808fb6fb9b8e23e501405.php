...
<div class="panel-list">
	<ul>
		<li><a href="javascript:;">付款编号：<?php echo ($detail["order_id"]); ?></a></li>
		<li><a href="javascript:;">付款时间：<?php echo (date('Y-m-d H:i',$detail["create_time"])); ?></a></li>
		<li><a href="javascript:;">付款方式：<?php echo ($paytype[$detail['code']]['name']); ?></a></li>
        <li><a href="javascript:;">结算价格：<em>￥<?php echo round($detail['need_pay']/100,2);?></em></a></li>
        
        <!--<li><a href="javascript:;">地址：<?php echo ($citys[$addr['city_id']]['name']); ?>&nbsp;<?php echo ($areas[$addr['area_id']]['area_name']); ?>&nbsp;<?php echo ($bizs[$addr['business_id']]['business_name']); ?>&nbsp;<?php echo ($addr['addr']); ?></a></li>-->
