...
<header class="top-fixed bg-yellow bg-inverse">
	...
	<div class="top-share">
		<a href="<?php echo U('favorites/lists');?>" id="share-btn"><i class="icon-plus"></i></a>
	</div>

</header>

<div class="line fav-search">
	<form method="post"  action="<?php echo U('favorites/index');?>" >
		<div class="form-group">
			<div class="field">
				<div class="input-group">
					<span class="addbtn"><button type="button" class="button icon-search"></button></span>
					<input type="text" class="input" name="keywords" size="50" value="<?php echo ($keyword); ?>" placeholder="输入您要搜索的内容"  />
...
<script>
	$(document).ready(function () {
		loaddata("<?php echo ($nextpage); ?>", $("#fav-list"), true);
	});
</script>
