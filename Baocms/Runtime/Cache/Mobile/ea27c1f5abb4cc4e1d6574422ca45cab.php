...
<html lang="zh-cn">
	...
	<header class="top-fixed bg-yellow bg-inverse">
		<div class="top-back">
			<a class="top-addr" href="<?php echo U('mcenter/member/xiaoxizhongxin');?>"><i class="icon-angle-left"></i></a>
		</div>
		<div class="top-title">
			我的小区发件箱
		</div>
...
<!-- 筛选TAB -->
<style>ul{ padding-left:0px;}.msg-list{ margin-top:2.2rem;}</style>
<ul id="shangjia_tab">
        <li style="width: 50%;"><a href="<?php echo U('message/index');?>" <?php if($act == index): ?>class="on"<?php endif; ?>>我收到的信件</a></li>
        <li style="width: 50%;"><a href="<?php echo U('message/famessage');?>" <?php if($act == famessage): ?>class="on"<?php endif; ?>>我发出的信件</a></li>
	...
	<script>
		$(document).ready(function () {
			loaddata('<?php echo ($nextpage); ?>', $("#msg-list"), true);
		});
	</script>
