...
<header class="top-fixed bg-yellow bg-inverse">
	...
	<div class="top-share">
		<a href="<?php echo U('life/index');?>" class="share-btn"><i class="icon-pencil-square-o"></i></a>
	</div>
</header>

<style>
.life-list { margin-top:0rem;}
ul{ padding-left:0px;}
</style>        
<ul id="shangjia_tab">
        ...
        <li style="width:16.66666667%;"><a href="<?php echo U('shop/life',array('shop_id'=>$detail['shop_id']));?>" class="on">信息</a></li>
