...
<ul id="shangjia_tab">
        ...
        <li style="width:16.66666667%;"><a href="<?php echo U('shop/tuan',array('shop_id'=>$detail['shop_id']));?>"  class="on">团购</a></li>
...
<div class="container">
<div class="main-tuan" id="main-tuan"></div>
	<script>
		$(document).ready(function () {
			loaddata('<?php echo ($nextpage); ?>', $("#main-tuan"), true);
		});
	</script>
</div>
