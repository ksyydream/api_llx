...
<html lang="zh-cn">
	...
	<header class="top-fixed bg-yellow bg-inverse">
		<div class="top-back">
			<a class="top-addr" href="<?php echo U('shop/detail',array('shop_id'=>$shop['shop_id']));?>"><i class="icon-angle-left"></i></a>
		</div>
		<div class="top-title">
	...
	<script>
		$(document).ready(function () {
			...
			$("#mui-card-close").click(function () {
                ...
                <?php $Shopdetails = D('Shopdetails') -> where('shop_id ='.$shop['shop_id']) -> find(); ?> 
               
	<div class="container">

		<div class="padding-large">
            <?php if(!empty($Shopdetails['wei_pic'])): ?><img src="<?php echo ($Shopdetails['wei_pic']); ?>" width="100%" />
            <?php else: ?>
            <img src="<?php echo config_img($CONFIG['site']['wxcode']);?>" width="100%" /><?php endif; ?>
		</div>
		<p class="text-center">微信里长按二维码，关注公众号即可关注商家</p>
