...
<div class="line banner">	
		...
		<div class="bd">
			...
			<div class="title">
				...
				<p>账户余额：<?php echo ($money); ?>元 &nbsp;&nbsp;
                秀币余额：<?php echo ($MEMBER['integral']); ?> &nbsp;&nbsp;优惠卡：<?php echo ($yhk); ?>
                </p>
			</div>	
		</div>
</div>   
...
<!--<div class="index-top">-->
		<!--<div class="line">-->
            ...
            <!--<?php if($open_mall == 1): ?>-->
			<!--<a class="x2 btn btn-3"  href="<?php echo LinkTo('goods/index',array('aready'=>1));?>"><i class="icon-cart-plus"></i><p>购物</p></a>-->
            <!--<?php endif; ?>-->
			<!--<a class="x2 btn btn-4"  href="<?php echo U('eleorder/index');?>"><i class="icon-cutlery"></i><p>外卖</p></a>-->
            <!--<?php if($open_ding == 1): ?>-->
			<!--<a class="x2 btn btn-5"  href="<?php echo LinkTo('ding/index',array('aready'=>-2));?>"><i class="icon-tty"></i><p>订座</p></a>-->
            <!--<?php endif; ?>-->
...
<li><a href="<?php echo U('money/detail');?>"><span class="icon-gears"></span>资金管理<i class="icon-angle-right"></i></a></li>
...
<div class="panel-list">
	...
	<ul>
		<li><a href="<?php echo LinkTo('goods/index');?>"><span class="icon-cart-plus"></span>我的订单<i class="icon-angle-right"></i></a></li>
		<li><a href="<?php echo LinkTo('team/index');?>"><span class="icon-user"></span>我的团队<i class="icon-angle-right"></i></a></li>
		<li><a href="<?php echo LinkTo('yhk/index');?>"><span class="icon-credit-card"></span>我的优惠卡<i class="icon-angle-right"></i></a></li>
		<li><a href="<?php echo LinkTo('money/cash');?>"><span class="icon-credit-card"></span>余额提现<i class="icon-angle-right"></i></a></li>
		...
		<!--<li>-->
			...
			<!--<a href="<?php echo U('coupon/index');?>">-->
				...
				<!--我的优惠券&nbsp; -->
                <!--<?php if($coupon > 0): ?>-->
                <!--<font>未使用：(<b><?php echo ($coupon); ?></b>)</font>-->
                <!--<?php else: ?>-->
                <!--<?php endif; ?> -->
...
<li><a href="<?php echo U('pay/index');?>"><span class="icon-tags"></span>优惠买单<i class="icon-angle-right"></i></a></li>
