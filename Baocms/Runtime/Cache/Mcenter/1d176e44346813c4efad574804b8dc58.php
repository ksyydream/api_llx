...
<!-- 筛选TAB -->
<ul id="shangjia_tab">
        <li style="width: 33.3333367%;"><a href="<?php echo LinkTo('goods/index');?>" <?php if(($aready) == ""): ?>class="on"<?php endif; ?>>全部订单</a></li>
        <li style="width: 33.3333367%;"><a href="<?php echo LinkTo('goods/index',array('aready'=>1));?>" <?php if(($aready) == "1"): ?>class="on"<?php endif; ?>>待付款</a></li>
        <li style="width: 33.3333367%;"><a href="<?php echo LinkTo('goods/index',array('aready'=>4));?>" <?php if(($aready) == "4"): ?>class="on"<?php endif; ?>>已完成</a></li>
</ul>
