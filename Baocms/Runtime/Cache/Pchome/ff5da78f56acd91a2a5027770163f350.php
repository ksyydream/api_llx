...
<div class="clear"></div>
<div class="about-main zy_content">
    <div class="about-content">
        <div class="about-centleft">
            <ul class="about-nav">
                <?php if(is_array($contents)): foreach($contents as $key=>$var): ?><li <?php if(($var["content_id"]) == $content_id): ?>class="on"<?php endif; ?> ><a title="<?php echo ($var["title"]); ?>" href="<?php echo U('article/system',array('content_id'=>$var['content_id']));?>"><?php echo ($var["title"]); ?></a></li><?php endforeach; endif; ?>
            </ul>
            <div class="about-qie">
                <ul class="about-us">
        ...
        <div class="nearbuy_wx right"><img src="__ROOT__/attachs/<?php echo ($CONFIG["site"]["wxcode"]); ?>" width="100" height="100" /></div>
    </div>
</div>
<div class="footerOut">
