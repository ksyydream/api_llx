...
<div class="content zy_content" id="life">
        ...
        <ul>
            <?php if(empty($cat)): ?><li class="goods_flList">
                    ...
                    <div class="left goods_flList_r">
                        <a href="<?php echo LinkTo('life/index',$linkArr,array('channel'=>0,'cat'=>0));?>" <?php if(empty($channel)): ?>class="goods_flListA on"<?php else: ?>class="goods_flListA"<?php endif; ?> >不限</a> 
                        <?php if(is_array($channelmeans)): foreach($channelmeans as $key=>$item): ?><a class="goods_flListA <?php if(($channel) == $key): ?>on<?php endif; ?>" href="<?php echo LinkTo('life/index',$linkArr,array('channel'=>$key,'cat'=>0));?>"><?php echo ($item); ?></a><?php endforeach; endif; ?>
                    </div>
                </li><?php endif; ?>
            <?php if(!empty($channel)): ?><li class="goods_flList">
                    <div class="left goods_flList_l">分类：</div>
                    <div class="left goods_flList_r">  
                        <a href="<?php echo LinkTo('life/index',$linkArr,array('cat'=>0));?>" <?php if(empty($cat)): ?>class="goods_flListA on"<?php else: ?>class="goods_flListA"<?php endif; ?> >全部</a> 
                        <?php if(is_array($cates)): foreach($cates as $key=>$item): if(($item["channel_id"]) == $channel): ?><a class='goods_flListA <?php if(($cat) == $item["cate_id"]): ?>on<?php endif; ?>' href="<?php echo LinkTo('life/index',$linkArr,array('cat'=>$item['cate_id']));?>"><?php echo ($item["cate_name"]); ?></a><?php endif; endforeach; endif; ?>
                    </div>
                </li><?php endif; ?>
            <?php if(!empty($cate) && !empty($cate['select1'])): ?><li class="goods_flList">
                    <div class="left goods_flList_l"><?php echo ($cate['select1']); ?>:</div>
                    <div class="left goods_flList_r">  
                        <a href="<?php echo LinkTo('life/index',$linkArr,array('s1'=>0));?>" <?php if(empty($s1)): ?>class="goods_flListA on"<?php else: ?>class="goods_flListA"<?php endif; ?> >全部</a> 
                        <?php if(is_array($attrs["select1"])): foreach($attrs["select1"] as $key=>$item): ?><a class='goods_flListA <?php if(($s1) == $item["attr_id"]): ?>on<?php endif; ?>' href="<?php echo LinkTo('life/index',$linkArr,array('s1'=>$item['attr_id']));?>"><?php echo ($item["attr_name"]); ?></a><?php endforeach; endif; ?>
                    </div>
                </li><?php endif; ?>
            <?php if(!empty($cate) && !empty($cate['select2'])): ?><li class="goods_flList">
                    <div class="left goods_flList_l"><?php echo ($cate['select2']); ?>:</div>
                    <div class="left goods_flList_r">  
                        <a href="<?php echo LinkTo('life/index',$linkArr,array('s2'=>0));?>" <?php if(empty($s2)): ?>class="goods_flListA on"<?php else: ?>class="goods_flListA"<?php endif; ?> >全部</a> 
                        <?php if(is_array($attrs["select2"])): foreach($attrs["select2"] as $key=>$item): ?><a class='goods_flListA <?php if(($s2) == $item["attr_id"]): ?>on<?php endif; ?>' href="<?php echo LinkTo('life/index',$linkArr,array('s2'=>$item['attr_id']));?>"><?php echo ($item["attr_name"]); ?></a><?php endforeach; endif; ?>
                    </div>
                </li><?php endif; ?>
            <?php if(!empty($cate) && !empty($cate['select3'])): ?><li class="goods_flList">
                    <div class="left goods_flList_l"><?php echo ($cate['select3']); ?>:</div>
                    <div class="left goods_flList_r">  
                        <a href="<?php echo LinkTo('life/index',$linkArr,array('s3'=>0));?>" <?php if(empty($s3)): ?>class="goods_flListA on"<?php else: ?>class="goods_flListA"<?php endif; ?> >全部</a> 
                        <?php if(is_array($attrs["select3"])): foreach($attrs["select3"] as $key=>$item): ?><a class='goods_flListA <?php if(($s3) == $item["attr_id"]): ?>on<?php endif; ?>' href="<?php echo LinkTo('life/index',$linkArr,array('s3'=>$item['attr_id']));?>"><?php echo ($item["attr_name"]); ?></a><?php endforeach; endif; ?>
                    </div>
                </li><?php endif; ?>
            <?php if(!empty($cate) && !empty($cate['select4'])): ?><li class="goods_flList">
                    <div class="left goods_flList_l"><?php echo ($cate['select4']); ?>:</div>
                    <div class="left goods_flList_r">  
                        <a href="<?php echo LinkTo('life/index',$linkArr,array('s4'=>0));?>" <?php if(empty($s4)): ?>class="goods_flListA on"<?php else: ?>class="goods_flListA"<?php endif; ?> >全部</a> 
                        <?php if(is_array($attrs["select4"])): foreach($attrs["select4"] as $key=>$item): ?><a class='goods_flListA <?php if(($s4) == $item["attr_id"]): ?>on<?php endif; ?>' href="<?php echo LinkTo('life/index',$linkArr,array('s4'=>$item['attr_id']));?>"><?php echo ($item["attr_name"]); ?></a><?php endforeach; endif; ?>
                    </div>
                </li><?php endif; ?>
            <?php if(!empty($cate) && !empty($cate['select5'])): ?><li class="goods_flList">
                    <div class="left goods_flList_l"><?php echo ($cate['select5']); ?>:</div>
                    <div class="left goods_flList_r">  
                        <a href="<?php echo LinkTo('life/index',$linkArr,array('s5'=>0));?>" <?php if(empty($s5)): ?>class="goods_flListA on"<?php else: ?>class="goods_flListA"<?php endif; ?> >全部</a> 
                        <?php if(is_array($attrs["select5"])): foreach($attrs["select5"] as $key=>$item): ?><a class='goods_flListA <?php if(($s5) == $item["attr_id"]): ?>on<?php endif; ?>' href="<?php echo LinkTo('life/index',$linkArr,array('s5'=>$item['attr_id']));?>"><?php echo ($item["attr_name"]); ?></a><?php endforeach; endif; ?>
                    </div>
                </li><?php endif; ?>
            <li class="goods_flList">
                <div class="left goods_flList_l">地区：</div>
                <div class="left goods_flList_r">  
                    <a href="<?php echo LinkTo('life/index',$linkArr,array('area'=>0,'business'=>0));?>" <?php if(empty($area)): ?>class="goods_flListA on"<?php else: ?>class="goods_flListA"<?php endif; ?> >全部</a> 
                    <?php if(is_array($areas)): foreach($areas as $key=>$item): if(($item["city_id"]) == $city_id): ?><a class='goods_flListA <?php if(($area) == $item["area_id"]): ?>on<?php endif; ?>' href="<?php echo LinkTo('life/index',$linkArr,array('area'=>$item['area_id'],'business'=>0));?>"><?php echo ($item["area_name"]); ?></a><?php endif; endforeach; endif; ?>
                </div>
            </li>
            <?php if(!empty($area)): ?><li class="goods_flList">
                    <div class="left goods_flList_l">商圈：</div>
                    <div class="left goods_flList_r">  
                        <a href="<?php echo LinkTo('life/index',$linkArr,array('area'=>$area,'business'=>0));?>" <?php if(empty($business)): ?>class="goods_flListA on"<?php else: ?>class="goods_flListA"<?php endif; ?> >全部</a> 
                        <?php if(is_array($bizs)): foreach($bizs as $key=>$item): if(($item["area_id"]) == $area): ?><a class='goods_flListA <?php if(($business) == $item["business_id"]): ?>on<?php endif; ?>' href="<?php echo LinkTo('life/index',$linkArr,array('area'=>$area,'business'=>$item['business_id']));?>"><?php echo ($item["business_name"]); ?></a><?php endif; endforeach; endif; ?>
                    </div>
                </li><?php endif; ?>
        </ul>
    </div>
    <div class="liveSearch">
        <span>
            <a class="fast_fabu" href="<?php echo U('life/fabu');?>">我要发布信息</a>
        </span>
        <div class="left liveSearchLeft">
            <form id="search_life2" action="<?php echo U('life/index',$linkArr);?>" method="post">
                <input class="liveInput" type="text" value="<?php echo ($keyword); ?>" name="keyword">
            ...
            <div class="hdxq_xqnr life_xq_nr">
                ...
                <ul class="liveBoxlist">
                    <?php if(is_array($list)): foreach($list as $key=>$var): ?><li>
                            <a title="<?php echo ($var["title"]); ?>" href="<?php echo U('life/detail',array('life_id'=>$var['life_id']));?>" target="_blank">
                                <img width="120" height="77" src="<?php echo config_img($var['photo']);?>" />
                            </a>
                            <h3>
                            ...
                            <p><?php echo ($areas[$var['area_id']]['area_name']); ?> - <?php echo ($bizs[$var['business_id']]['business_name']); ?> - <?php echo ($var["addr"]); ?></p>
                        <?php if(!empty($var['num1'])): ?><p class="red"><?php echo ($var["num1"]); echo ($cates[$var['cate_id']]['unit1']); ?></p>
                            <?php else: ?>
                            <p class="red"><?php echo ($var["text1"]); ?></p><?php endif; ?>
