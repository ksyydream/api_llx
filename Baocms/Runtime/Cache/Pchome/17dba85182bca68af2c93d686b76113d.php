...
.header--mini{border-bottom:2px solid <?php echo ($color); ?>!important;min-width:980px;color:#666}
...
<div class="header--mini">
    <div class="wrapper cf">
        <a class="site-logo" href="/">欢迎登录<?php echo ($CONFIG['site']['sitename']); ?></a>
        <div class="login-block">
            <span class="tip">没有<?php echo ($CONFIG['site']['sitename']); ?>账号？</span>
            <a class="btn btn-small login" href="<?php echo U('passport/register');?>">注册</a>
        </div>
    </div>
</div>
		...
		<div class="loginBox">
			<form id="login_frm"  action="<?php echo U('passport/login');?>" method="post" target="baocms_frm">
				...
				<table cellpadding="0" cellspacing="0" width="100%" class="loginTable">
					<tr>
						<td>
							<input type="text" id="account"  name="account" placeholder="邮箱/手机号"    class="loginInput" value="" />
						</td>
					</tr>
					<tr>
						<td>
							<input type="password" id="password"  name="password"  class="loginInput2" placeholder="密码" value="" />
						</td>
					</tr>
					<tr>
						<td>
							<input  class="loginInput2 loginInput4"  id="yzm"  name="yzm"  type="text"  value="" placeholder="验证码" />
					...
					<tr>
						<td><a href="<?php echo U('passport/register');?>" class="btn loginInput6">注 册</a></td>
					</tr>
				</table>
			</form>
			<ul class="qqlink">
