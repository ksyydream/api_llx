...
<div class="sy_partOne">
    ...
    <?php if(empty($MEMBER)): ?><!--未登录-->
            <div class="loginBox">
                <div class="clearfix">
                    <div class="avatar">
                        <img src="<?php echo config_img($user['face']);?>" width="50" style=" border-radius:100%" height="50" class="img-avatar" />
                    </div>
                    <div class="login">
                        <div><font>hi，
        ...
        <div class="clearfix">
            ...
            <dl class="tabRank" id="tabRank">
                <dt class="hd">
                    <h3 class="one on"><a href="javascript:void(0);">公告</a></h3>
                    <h3 class="two"><a href="javascript:void(0);">新闻</a></h3>
                    <h3><a href="javascript:void(0);">供货</a></h3>
                    <h3><a href="javascript:void(0);">连锁</a></h3>
                </dt>
                <dd class="bd">
                    <div style="width:209px;" class="listA-box">
                    <?php  $cache = cache(array('type'=>'File','expire'=> 600)); $token = md5("Systemcontent,create_time desc,0,5,600,,,"); if(!$items= $cache->get($token)){ $items = D("Systemcontent")->where("")->order("create_time desc")->limit("0,5")->select(); $cache->set($token,$items); } ; $index=0; foreach($items as $item): $index++; ?><a href="<?php echo U('article/system',array('content_id'=>$item['content_id']));?>" target="_blank">
                        【公告】<?php echo bao_msubstr($item['title'],0,10,false);?><i class="icons-hot"></i></a> <?php endforeach; ?>		
                    </div>
                    <div style="width:209px;" class="listA-box">
                    ...
                    <div style="width:209px;">
                        <ul class="step-block lesslinemar">
                            <li><a href="<?php echo U('pchome/article/system',array('content_id'=>1));?>" target="_blank">注册会员</a><em class="fontSong">&gt;</em></li>
                            <li><a href="<?php echo U('pchome/article/system',array('content_id'=>1));?>" target="_blank">实名认证</a><em class="fontSong">&gt;</em></li>
                            <li><a href="<?php echo U('pchome/article/system',array('content_id'=>1));?>" target="_blank" class="jiakuan">开通<br>供货站</a></li>
                        </ul>
                        <ul class="youshi">
                            <li><a href="<?php echo U('pchome/article/system',array('content_id'=>1));?>" target="_blank">平台优势</a></li>
                            <li><a href="<?php echo U('pchome/article/system',array('content_id'=>1));?>" target="_blank">资质要求</a></li>
                            <li><a href="<?php echo U('pchome/article/system',array('content_id'=>1));?>" target="_blank">审核时间</a></li>
                            <li><a href="<?php echo U('pchome/article/system',array('content_id'=>1));?>" target="_blank">费用收取</a></li>
                        </ul>
                    </div>
                    <div style="width:209px;">
                        <ul class="step-block lesslinemar">
                            <li><a href="<?php echo U('pchome/article/system',array('content_id'=>1));?>" target="_blank">注册会员</a><em class="fontSong">&gt;</em></li>
                            <li><a href="<?php echo U('pchome/article/system',array('content_id'=>1));?>" target="_blank">实名认证</a><em class="fontSong">&gt;</em></li>
                            <li><a href="<?php echo U('pchome/article/system',array('content_id'=>1));?>" target="_blank" class="jiakuan">开通<br>连锁站</a></li>
                        </ul>
                        <ul class="youshi">
                            <li><a href="<?php echo U('pchome/article/system',array('content_id'=>1));?>" target="_blank">平台优势</a></li>
                            <li><a href="<?php echo U('pchome/article/system',array('content_id'=>1));?>" target="_blank">资质要求</a></li>
  ...
  <!--首页优惠券部分开始-->
    ...
    <div class="sy_seat_nr">
        <div class="left sy_seat_list">
            <ul>
                <?php  $cache = cache(array('type'=>'File','expire'=> 600)); $token = md5("Shop,600,is_ding=1 AND audit=1 AND closed=0 AND  city_id=$city_id,0,4,orderby asc,score desc,,"); if(!$items= $cache->get($token)){ $items = D("Shop")->where("is_ding=1 AND audit=1 AND closed=0 AND  city_id=$city_id")->order("orderby asc,score desc")->limit("0,4")->select(); $cache->set($token,$items); } ; $index=0; foreach($items as $item): $index++; ?><li>
                        <div class="syPub_list">
                            <div class="img">
                                <a target="_blank" href="<?php echo U('ding/detail',array('shop_id'=>$item['shop_id']));?>">
                            ...
                            <p class="graycl">价格<?php echo ($item['d1']); ?>&nbsp;&nbsp;环境<?php echo ($item['d2']); ?>&nbsp;&nbsp;服务<?php echo ($item['d3']); ?></p>
                            <hr style="border:none 0px; border-bottom: 1px solid #e0e0e0; margin-top:6px;" />
                            <div class="btn_box">
                                <div class="left"><p class="graycl">浏览数：<?php echo ($item["view"]); ?></p></div>
                                <div class="right"><a target="_blank" href="<?php echo U('ding/detail',array('shop_id'=>$item['shop_id']));?>" class="btn">立即预订</a></div>
                            </div>
                        </div>
                    </li> <?php endforeach; ?>
            </ul>
