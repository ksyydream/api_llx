...
<div class="topOne">
    <div class="nr">
        <?php if(empty($MEMBER)): ?><div class="left">您好，欢迎访问<?php echo ($CONFIG["site"]["sitename"]); ?><a href="<?php echo u('home/passport/login');?>" class="on">登陆</a>|<a href="<?php echo U('passport/register');?>">注册</a>
        <?php else: ?>
        <div class="left">欢迎 <b style="color: red;font-size:14px;"><?php echo ($MEMBER["nickname"]); ?></b> 来到<?php echo ($CONFIG["site"]["sitename"]); ?>&nbsp;&nbsp; <a href="<?php echo u('members/index/index');?>" class="maincl" >个人中心</a><a href="<?php echo u('home/passport/logout');?>" class="maincl" >退出登录</a><?php endif; ?>
...
<script>
	...
	<div class="topTwo">
        ...
        <div class="left">
            ...
            <?php if(!empty($CONFIG['site']['logo'])): ?><h1><a href="<?php echo u('home/index/index');?>"><img src="<?php echo config_img($city['photo']);?>" width="215" height="65" /></a></h1>
            <?php else: ?>
            <h1><a href="<?php echo u('home/index/index');?>"><img src="<?php echo config_img($CONFIG['site']['logo']);?>" /></a></h1><?php endif; ?> 
        ...
        <script>
            ...
            <div class="searchBox">
                ...
                <form id="search_form"  method="post" action="<?php echo u('home/shop/index');?>">
                ...
                <div class="selectBox"> <span class="select"  id="selectBoxInput">商家</span>
                    ...
                    <div  class="selectList">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:void(0);" <?php if($ctl == 'ding'){?> cur='true'<?php }?>rel="<?php echo u('home/ding/index');?>">订座</a></li>
    ...
    <!--<div class="topTwo">
        ...
        <div class="left">
            ...
            <div class="changeCity"><a href="<?php echo u('home/city/index');?>" class="changeCity_name"><?php echo ($city_name); ?></a></div>
            ...
            <ul>
             ...
             <?php if(is_array($list)): foreach($list as $key=>$item): ?><li class="nearbuy_cpLi">
                        ...
                        <div class="sy_sjcpLi nearbuy_cpLik">
                            ...
                            <p class="sy_hottjJg"><span class="left">¥<?php echo ($item["mall_price"]); ?><del>¥<?php echo ($item["price"]); ?></del></span><span class="right">已售<?php echo ($item["sold_num"]); ?></span></p>
