...
<div class="mainBt">
    <ul>
        ...
        <li class="li2 li3">商城订单</li>
    </ul>
</div>
<div class="main-jsgl main-sc">
    <p class="attention"><span>注意：</span>管理员在此处理商城订单分成</p>
    <div class="jsglNr">
        <div class="selectNr" style="margin-top: 0px; border-top:none;">
            <div class="right">
                <form action="<?php echo U('profit/order');?>" method="post" >
            ...
            <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                        ...
                        <td>
                           ...
                           <br/>
                             <?php $statuss = D('Ordergoods') -> where('order_id ='.$var['order_id']) -> find(); $status = $statuss['status']; ?> 
                            <?php if($status == 1): ?><a style="color:#f60;">【退款中】</a><?php endif; ?>
                            <?php if($status == 3): ?><a style="color:#000;">【已退款】</a><?php endif; ?>
                        ...
                        <td>
                            <?php if($var['is_separate'] == 0 and $var['fuid1'] > 0): echo BA('profit/ok',array("order_id"=>$var["order_id"], "order_type"=>1),'分成','act','remberBtn');?>
                                <?php echo BA('profit/cancel',array("order_id"=>$var["order_id"], "order_type"=>1),'取消','act','remberBtn');?>
                            <?php elseif($var['is_separate'] == 1): ?>
                                <?php echo BA('profit/rollback',array("order_id"=>$var["order_id"], "order_type"=>1),'撤消','act','remberBtn');?>
                            <?php else: ?>
                                -<?php endif; ?>
                        </td>
