...
<div class="main-jsgl main-sc">
    <div class="jsglNr">
        <div class="selectNr" style="margin-top: 0px; border-top:none;">
            <div class="right">
                <form  method="post"  action="<?php echo U('housework/index');?>"> 
                    <div class="seleHidden" id="seleHidden">
                        ...
                        <span>关键字</span>
                        <input type="text"  class="inptText" name="keys" value="<?php echo ($housework); ?>"  />
        ...
        <form  target="baocms_frm" method="post">
            <div class="tableBox">
                <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                    <tr>
                        <td class="w50"><input type="checkbox" class="checkAll" rel="housework_id" /></td>
                        <td>服务项目</td>
                        <td>服务时间</td>
                        <td>姓名</td>
                        <td>电话</td>
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                            <td><input class="child_housework_id" type="checkbox" name="housework_id[]" value="<?php echo ($var["housework_id"]); ?>" /></td>
                            <td><?php echo ($cates[$var['cate_id']]['cate_name']); ?></td>
                            <td><?php echo ($var["svctime"]); ?></td>
                            <td><?php echo ($var["name"]); ?></td>
                            <td><?php echo ($var["tel"]); ?></td>
                            <td><?php echo ($var["contents"]); ?></td>
                            <td><?php if(($var["is_real"]) == "1"): ?>真实需求<?php else: ?>未确认<?php endif; ?></td>
                        <td><?php echo round($var['money']/100,2);?></td>
                        <td><?php echo (date('Y-m-d H:i:s',$var["create_time"])); ?></td>
                        <td>
                            <?php echo BA('housework/edit',array("housework_id"=>$var["housework_id"]),'编辑','load','remberBtn',600,400);?>
                            <?php echo BA('housework/delete',array("housework_id"=>$var["housework_id"]),'删除','act','remberBtn');?>
                        </td>
            ...
            <div class="selectNr" style="margin-bottom: 0px; border-bottom: none;">
                <div class="left">
                    <?php echo BA('housework/delete','','批量删除','list','a2');?>
                </div>
            </div>
        </form>
    </div>
