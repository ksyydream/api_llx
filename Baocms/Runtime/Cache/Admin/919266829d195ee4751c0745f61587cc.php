...
<div class="mainScAdd ">
    ...
    <div class="tableBox">
        <form  target="baocms_frm" action="<?php echo U('goods/create');?>" method="post">
                 ...
                 <tr>
                    ...
                    <td class="rgTdBt">
                          ...
                          <select name="parent_id" id="parent_id" class="seleFl w100" style="display: inline-block; margin-right: 10px;">
                            ...
                            <?php if(is_array($cates)): foreach($cates as $key=>$var): if(($var["parent_id"]) == "0"): ?><option value="<?php echo ($var["cate_id"]); ?>"><?php echo ($var["cate_name"]); ?>(<?php echo ($var["rate"]); ?>‰)</option><?php endif; endforeach; endif; ?>
                        </select>
