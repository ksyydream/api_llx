...
<div class="main-jsgl main-sc">
    <p class="attention"><span>注意：</span>按月统计</p>
    <div class="jsglNr">
        
        <form method="post" action="<?php echo U('shopmoney/tjmonth');?>">
            <div class="selectNr selectNr2" style="display: block;">
                <div class="left">
                    <div class="seleK">
                        ...
                        <label>
                            <span>月份</span>
                            <input type="text" name="month" value="<?php echo (($month)?($month):''); ?>" onfocus="WdatePicker({dateFmt: 'yyyy-MM'});"  class="text" />
                        </label>
                        <label>
