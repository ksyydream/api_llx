...
<div class="main-jsgl main-sc">
    ...
    <div class="jsglNr">
        <div class="selectNr" style="margin-top: 0px; border-top:none;">
            ...
            <div class="right">
                <form class="search_form" method="post" action="<?php echo U('work/index');?>">
    ...
    <form  target="baocms_frm" method="post">
        <div class="tableBox">
            <table bordercolor="#e1e6eb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                        <td><input class="child_work_id" type="checkbox" name="work_id[]" value="<?php echo ($var["work_id"]); ?>" /></td>
                        <td><?php echo ($var["work_id"]); ?></td>
                        <td><?php echo ($shops[$var['shop_id']]['shop_name']); ?></td>
                        <td width='200'><?php echo ($var["intro"]); ?></td>
                    ...
                    <td>
                        ...
                        <?php echo BA('work/delete',array("work_id"=>$var["work_id"]),'删除','act','remberBtn');?>
                        <?php if(($var["audit"]) == "0"): echo BA('work/audit',array("work_id"=>$var["work_id"]),'审核','act','remberBtn'); endif; ?>
        ...
        <div class="selectNr" style="margin-bottom: 0px; border-bottom: none;">
            <div class="left">
                <?php echo BA('work/audit','','批量审核','list','remberBtn');?>
                <?php echo BA('work/delete','','批量删除','list',' a2');?>
            </div>
        </div>
    </form>
</div>
