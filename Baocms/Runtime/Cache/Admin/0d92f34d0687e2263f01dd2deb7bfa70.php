...
<div class="mainBt">
    <ul>
        <li class="li1">商户</li>
        <li class="li2">商户日志</li>
        <li class="li2 li3">商户资金日志</li>
    </ul>
</div>
<div class="main-jsgl main-sc">
    <div class="jsglNr">
        <div class="selectNr" style="margin-top: 0px; border-top:none;">
            <div class="right">
                <form class="search_form" method="post" action="<?php echo U('usergoldlogs/index');?>">
        ...
        <form method="post" action="<?php echo U('usergoldlogs/index');?>">
