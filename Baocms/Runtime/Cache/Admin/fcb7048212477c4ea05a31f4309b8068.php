...
<div class="main-jsgl main-sc">
    ...
    <div class="selectNr" style="margin-top: 0px; border-top:none;">
            <div class="left">
                ...
                <?php if(is_array($citys)): foreach($citys as $key=>$item): ?><a <?php if($item['city_id'] == $city_id): ?>class="on"<?php endif; ?> href="<?php echo U('admin/fenzhanshopmoney/index',array('city_id'=>$item['city_id']));?>"><?php echo ($item["name"]); ?></a><?php endforeach; endif; ?>
