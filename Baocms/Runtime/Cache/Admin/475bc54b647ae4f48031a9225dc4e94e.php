<?php if (!defined('THINK_PATH')) exit();?><div class="listBox clfx">
    <div class="menuManage">
        <form  target="baocms_frm" action="<?php echo U('area/edit',array('area_id'=>$detail['area_id']));?>" method="post">
            <div class="mainScAdd">
                <div class="tableBox">
                    <table bordercolor="#e1e6eb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;" >
                        <tr>
                            <td class="lfTdBt">区域名称：</td>
                            <td class="rgTdBt"><input type="text" name="data[area_name]" value="<?php echo (($detail["area_name"])?($detail["area_name"]):''); ?>" class="manageInput" />
                            </td>
                        </tr>
