...
<div class="main-jsgl main-sc">
    <p class="attention"><span>注意：</span>前台申请，后台审核！会员申请链接：你的域名后面/shop/apply</p>
    <div class="jsglNr">
        <div class="selectNr" style="margin-top: 0px; border-top:none;">
            ...
            <div class="right">
                <form class="search_form" method="post" action="<?php echo U('shop/apply');?>">
        ...
        <form method="post" action="<?php echo U('shop/apply');?>">
            ...
            <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                       ...
                       tag: <?php echo ($var["tags"]); ?>
                        ...
                        <td><img style="padding:2px; height:60px; width:60px;" src="__ROOT__/attachs/<?php echo ($var["logo"]); ?>" /></td>
                        
                    <td><?php echo (date('Y-m-d H:i:s',$var["create_time"])); ?></td>
                    <td class="w150">
                    <?php echo BA('shop/edit',array("shop_id"=>$var["shop_id"]),'编辑','','remberBtn_small');?>
                    <?php echo BA('shop/audit',array("shop_id"=>$var["shop_id"]),'审核','act','remberBtn_small');?>
                    <?php echo BA('shop/delete',array("shop_id"=>$var["shop_id"]),'删除','act','remberBtn_small');?>
