<?php if (!defined('THINK_PATH')) exit();?><div class="listBox clfx" style="width: 800px;">
    <div class="menuManage">
        <form  target="baocms_frm" action="<?php echo U('shopcate/create',array('parent_id'=>$parent_id));?>" method="post">
            <div class="mainScAdd">
                <div class="tableBox">
