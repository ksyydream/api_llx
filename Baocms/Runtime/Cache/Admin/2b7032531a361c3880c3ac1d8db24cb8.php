...
<div class="main-jsgl main-sc">
    ...
    <form target="baocms_frm" method="post">
        <div class="tableBox">
            <table bordercolor="#e1e6eb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                    ...
                    <td>
                    <?php if($var["status"] == 0): echo BA('usercash/audit_integral',array("cash_id"=>$var["cash_id"], "status" => 1),'通过','act','remberBtn');?>
        ...
        <script>
            $(document).ready(function () {
                ...
                $(".jujue").click(function () {
                    ...
                    var url = "<?php echo U('usercash/jujue_integral');?>";
        ...
        <div class="selectNr" style="margin-bottom: 0px; border-bottom: none;">
            <div class="left">
                <?php echo BA('usercash/audit',array("status" => 1),'批量通过','list',' remberBtn');?>
                <!--<?php echo BA('usercash/audit',array("status" => 2),'批量拒绝','list',' a2');?> -->
            </div>
        </div>
    </form>
</div>
