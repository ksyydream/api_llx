    ...
    <div class="left sjgl_leftmenu">
        <ul>
			...
			<?php if(($open_mall) == "1"): ?><li class="leftMenu_li"><a class="leftMenu_a leftMenu_a4" target="main_frm" href="<?php echo U('goods/index');?>"><em>&nbsp;</em>商城</a>
             ...
             <!--<?php if(!empty($waimai)): ?>&lt;!&ndash;如果商户开通外卖&ndash;&gt;-->
            	...
            	<!--<div class="leftNav2">-->
                    <!--<ul>-->
                        ...
                        <!--<?php endif; ?>-->
                        <!--<?php if(($SHOP["is_pei"]) == "0"): ?>-->
                            <!--<li><a target="main_frm" href="<?php echo U('eleorder/wait');?>"><em>&nbsp;</em>确认订单</a></li>-->
                        	<!--<li><a target="main_frm" href="<?php echo U('eleorder/count');?>"><em>&nbsp;</em>配送员订单统计</a></li>-->
                            <!--<li><a target="main_frm" href="<?php echo U('eleorder/whole');?>"><em>&nbsp;</em>全部订单</a></li>-->
                        <!--<?php endif; ?>-->
                    <!--</ul>-->
                <!--</div>-->
            <!--</li>-->
          ...
          <!--<?php if($ding['is_biz'] != 0): ?>&lt;!&ndash;如果后台开通黄页&ndash;&gt;-->
           ...
           <li class="leftMenu_li"><a class="leftMenu_a leftMenu_a5" target="main_frm" href="<?php echo U('fans/index');?>"><em>&nbsp;</em>粉丝</a>
            	<div class="leftNav2">
                    <ul>
                        ...
                        <!--<li><a target="main_frm" href="<?php echo U('integrallogs/index');?>"><em>&nbsp;</em>秀币日志</a></li>-->
                        <li><a target="main_frm" href="<?php echo U('fans/yhk_users');?>"><em>&nbsp;</em>购卡会员</a></li>
             ...
             <!--<li class="leftMenu_li"><a class="leftMenu_a leftMenu_a10" target="main_frm" href="<?php echo U('weixin/index');?>"><em>&nbsp;</em>营销管理</a>-->
            	<!--<div class="leftNav2">-->
                    <!--<ul>-->
                        ...
                        <!--&lt;!&ndash;<li><a target="main_frm" href="<?php echo U('help/index');?>"><em>&nbsp;</em>微助力</a></li>&ndash;&gt;-->
