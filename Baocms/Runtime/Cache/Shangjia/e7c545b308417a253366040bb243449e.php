  ...
  <tr>
    ...
    <?php if(is_array($goods)): foreach($goods as $key=>$good): if(($good["order_id"]) == $order["order_id"]): ?><table  class="tuan_table2" width="100%" border="0">
      <tr class="tr_left_1">
        ...
        <a  target="_blank"  href="javascript:;" class="index__pic___TScfk" ><img src="__ROOT__/attachs/<?php echo ($products[$good['goods_id']]['photo']); ?>" ><span></span></a>
        <div class="index__infos___A6XLq" >
            <p ><a href="javascript:;" target="_blank" ><span ></span><span><?php echo ($products[$good['goods_id']]['title']); ?></span><span ></span></a><span></span><span></span></p>
            <span></span>
            <p><a href="javascript:;" style="margin-right:8px;" target="_blank" ><img src="https://img.alicdn.com/tps/i4/T1BCidFrNlXXaSQP_X-16-16.png" ></a>
</p>
            <span></span>
        	</div>
		</div>
    ...
    <span>-<?php echo round($order['use_integral']/100,2);?></span><br/>
    <!--<a class="href" href="">查看物流</a>-->
    </td>
    <!--<td class="left9"width="9%"><?php if(($order["is_dianping"]) == "1"): ?>已点评<?php endif; ?></td>-->
    <td class="left9"width="9%"><?php echo round(($order['total_price'] - $order['use_integral'])/100,2);?></td>
  </tr>
