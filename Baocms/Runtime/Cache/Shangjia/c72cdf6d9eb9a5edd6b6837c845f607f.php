    ...
    <div class="tabnr_change  show">
    	...
    	<table class="tuanfabu_table" width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
                  ...
                  <script>
                    var ajaxurl = '<?php echo U("goods/ajax",array("cate_id"=>"0000","goods_id"=>$detail["goods_id"]));?>';
            ...
            <tr>
                ...
                <td><div class="tuanfabu_nr">
                    否 <input type="radio" name="data[is_yhk]" onclick="change_yhk(0)" value="0" <?php if($detail['is_yhk'] == 0): ?>checked="checked"<?php endif; ?>/>
                    是 <input type="radio" name="data[is_yhk]" onclick="change_yhk(1)" value="1" <?php if($detail['is_yhk'] == 1): ?>checked="checked"<?php endif; ?>/>

                </div></td>
            </tr>
            <tr class="yhk_info" <?php if($detail['is_yhk'] != 1): ?>style="display:none"<?php endif; ?>>
                <td width="120"><p class="tuanfabu_t">优惠券金额：</p></td>
                <td><div class="tuanfabu_nr">
                    <input type="text" name="data[yhq]" value="<?php echo ($detail['yhq']); ?>" class="tuanfabu_int tuanfabu_intw2" />
                </div></td>
            </tr>
        </table>


                <div class="radius5 tuan_top yhk_info" <?php if($detail['is_yhk'] != 1): ?>style="display:none"<?php endif; ?>>
                    <div class="tuan_top_t">
                        <div class="left tuan_topser_l">优惠卡赠品&nbsp;&nbsp;<button class="radius3 sjgl_an tuan_topbt" onclick="return add_zengpin()">增加赠品</button></div>
                    </div>
                </div>
                <div id="append_zengpin" class="yhk_info" <?php if($detail['is_yhk'] != 1): ?>style="display:none"<?php endif; ?>>
                    <?php if(is_array($zengpin)): foreach($zengpin as $key=>$row): ?><div>
                            <input type="text" placeholder="赠品名称" name="desc[]" value="<?php echo ($row["desc"]); ?>" class="tuanfabu_int tuanfabu_intw2">
                            <input type="text" placeholder="赠品数量" name="qty[]"  value="<?php echo ($row["qty"]); ?>" class="tuanfabu_int tuanfabu_intw2">
