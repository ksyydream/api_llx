...
<div class="tuan_content">
    ...
    <div class="tabnr_change  show">
    	<form method="post" action="<?php echo U('shop/image');?>"  target="baocms_frm">
        <script type="text/javascript" src="__PUBLIC__/js/uploadify/jquery.uploadify.min.js"></script>
        <link rel="stylesheet" href="__PUBLIC__/js/uploadify/uploadify.css">
    	<table class="tuanfabu_table" width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="120"><p class="tuanfabu_t">商铺形象照：</p></td>
                <td><div class="tuanfabu_nr">
                <div style="width: 300px;height: 100px; float: left;">
                    <input type="hidden" name="photo" value="<?php echo ($SHOP["photo"]); ?>" id="data_img" />
                    <input id="logo_file" name="logo_file" type="file" multiple="true" value="" />
                </div>
                <div style="width: 300px;height: 100px; float: left;">
                    <img id="image_show" width="80" height="80"  src="__ROOT__/attachs/<?php echo (($SHOP["photo"])?($SHOP["photo"]):'default.jpg'); ?>" />
