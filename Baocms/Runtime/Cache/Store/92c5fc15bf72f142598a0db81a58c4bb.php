...
<div class="container">
		<div class="line detail-base">
			...
			<div class="x7">
				<h1><?php echo ($SHOP["shop_name"]); ?>（ID:<?php echo ($SHOP["shop_id"]); ?>）</h1>
                ...
                <p>商户资金： &yen; <?php echo round($MEMBER['gold']/100,2);?> 元&nbsp;<a href="<?php echo U('store/money/cash');?>" style="color: #00A0E9">提现</a></p>
                <p>商户秀币： <?php echo ($MEMBER['integral']); ?> <a href="<?php echo U('store/money/integral');?>" style="color: #00A0E9">提现</a></p>
...
<li><a href="<?php echo U('shop/about');?>"><span class="icon-gears "></span>
基本设置
...
<li><a href="<?php echo U('pay/index');?>"><span class="icon-tags"></span>
	优惠买单
...
<!--<font>-->
<!--<?php if($counts['tuan_order_code_is_used'] > 0): ?>-->
<!--待验证<?php echo ($counts['tuan_order_code_is_used']); ?>单-->
<!--<?php endif; ?>-->
<!--<?php if($counts['tuan_order_code_is_used_ture'] > 0): ?>-->
<!--，已验证<?php echo ($counts['tuan_order_code_is_used_ture']); ?>单-->
<!--<?php endif; ?>-->
<!--<?php if($counts['tuan'] > 0): ?>-->
<!--，抢购<?php echo ($counts['tuan']); ?>单-->
<!--<?php endif; ?>-->
<!--<?php if($counts['tuan_audit'] > 0): ?>-->
<!--，待审核<b><?php echo ($counts['tuan_audit']); ?></b>单-->
<!--<?php endif; ?>-->
<!--</font>-->
<!--<i class="icon-angle-right"></i></a></li>-->
...
<!--<?php if($counts['coupon'] > 0): ?>-->
<!--共<?php echo ($counts['coupon']); ?>优惠劵-->
<!--<?php endif; ?>-->

<!--<?php if($counts['coupon_audit'] > 0): ?>-->
<!--，<b><?php echo ($counts['coupon_audit']); ?></b>待审-->
<!--<?php endif; ?>-->

<!--<?php if($counts['coupon_download'] > 0): ?>-->
<!--，总<?php echo ($counts['coupon_download']); ?>次下载-->
<!--<?php endif; ?>-->

<!--<?php if($counts['coupon_download_is_used'] > 0): ?>-->
<!--，待验<b><?php echo ($counts['coupon_download_is_used']); ?></b>。-->
<!--<?php endif; ?>-->
...
<!--<font>-->
<!--<?php if($counts['ele_order_two'] > 0): ?>-->
<!--已发货<?php echo ($counts['ele_order_two']); ?>单，-->
<!--<?php endif; ?>-->
<!--<?php if($counts['totay_ele_order'] > 0): ?>-->
<!--今日新增<b><?php echo ($counts['totay_ele_order']); ?></b>单-->
<!--<?php endif; ?>-->
<!--</font>-->
<!--<i class="icon-angle-right"></i></a></li>-->

<!--<?php if($open_life == 1): ?>-->
<!--<li><a href="<?php echo U('life/index');?>"><span class="icon-truck"></span>同城信息-->
<!--<font>-->
<!--<?php if($counts['life'] > 0): ?>-->
<!--<?php echo ($counts['life']); ?>条，-->
<!--<?php endif; ?>-->
<!--<?php if($counts['life_audit'] > 0): ?>-->
<!--<b><?php echo ($counts['life_audit']); ?></b>待审核-->
<!--<?php endif; ?>-->
<!--</font>-->
<!--<i class="icon-angle-right"></i></a></li>-->
<!--<?php endif; ?>-->
...
<!--<?php if($open_ding == 1): ?>-->
<!--<li><a href="<?php echo U('Ding/index');?>"><span class="icon-cog"></span>订座-->
<!--<font>-->
<!--<?php if($counts['ding_order'] > 0): ?>-->
<!--<?php echo ($counts['ding_order']); ?>人订座-->
<!--<?php endif; ?>-->
<!--<?php if($counts['totay_ding_order'] > 0): ?>-->
<!--，今日新增<b><?php echo ($counts['totay_ding_order']); ?></b>单-->
<!--<?php endif; ?>-->
<!--</font>-->
<!--<i class="icon-angle-right"></i></a></li>-->
<!--<?php endif; ?>-->
...
<!--<font>-->
<!--<?php if($counts['work'] > 0): ?>-->
<!--<?php echo ($counts['work']); ?>条招聘-->
<!--<?php endif; ?>-->
<!--<?php if($counts['work_audit'] > 0): ?>-->
<!--，<b><?php echo ($counts['work_audit']); ?></b>条待审核-->
<!--<?php endif; ?>-->
<!--</font>-->
<!--<i class="icon-angle-right"></i></a></li>-->
...
<!--<font>-->
<!--<?php if($counts['shopyuyue_one'] > 0): ?>-->
<!--<?php echo ($counts['shopyuyue_one']); ?>条预约-->
<!--<?php endif; ?>-->
<!--<?php if($counts['shopyuyue_eight'] > 0): ?>-->
<!--，<b><?php echo ($counts['shopyuyue_eight']); ?></b>条待确认-->
<!--<?php endif; ?>-->
<!--</font>-->
<!--<i class="icon-angle-right"></i></a></li>-->
...
<!--<?php if($open_lifeservice == 1): ?>-->
<!--<li><a href="<?php echo U('housework/index');?>"><span class="icon-random"></span>家政服务<i class="icon-angle-right"></i></a></li>-->
<!--<?php endif; ?>-->
<li><a href="<?php echo U('money/detail');?>"><span class="icon-calendar"></span>资金结算<i class="icon-angle-right"></i></a></li>

<li><a href="<?php echo U('money/integral_detail');?>"><span class="icon-calendar"></span>秀币结算<i class="icon-angle-right"></i></a></li>
