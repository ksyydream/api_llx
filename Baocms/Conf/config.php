...
$configs =  array(
    ...
    //'配置项'=>'配置值'
    'APP_GROUP_LIST' => 'Apishop,Apipublic,Apiuser,Apixiu,Admin,Shangjia,Mobile,Delivery,Store,App,Wuye,Mcenter,Member,Pchome,Fenzhan,Weixin,Worker,Community', //项目分组设定
